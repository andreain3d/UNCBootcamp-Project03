...
//       if (hands[i].index === hands[i - 1].index && hands[i].totalValue === hands[i - 1].totalValue) {
//         hands[i].rank = rank;
//       } else {
//         rank++;
//         hands[i].rank = rank;
...
function Table(buyIn = 200, bigBlind = 12, smallBlind = 6, autoIncrementBlinds = false, limit = true) {
  this.buyIn = buyIn;
  this.bigBlind = bigBlind;
  this.smallBlind = smallBlind;
  this.autoIncrementBlinds = autoIncrementBlinds;
